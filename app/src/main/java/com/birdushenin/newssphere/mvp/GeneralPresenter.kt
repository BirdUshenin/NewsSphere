...
class GeneralPresenter(
    private val sportsViewModel: GeneralViewModel,
    private val filterViewModel: FilterViewModel,
    private val searchViewModel: SearchViewModel,
    private val updateViewModel: UpdateViewModel
) {
    private lateinit var fragment: GeneralFragment
    private lateinit var binding: FragmentGeneralBinding
    private var fragmentReference: WeakReference<GeneralFragment>? = null

    fun attach(fragment: GeneralFragment, binding: FragmentGeneralBinding) {
